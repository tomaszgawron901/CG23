...
public class BaseParallelMergeSort extends RecursiveTask<List<Long>> {

    private List<Long> array;
    private List<Long> scratch; // scratch space used for merging

    public BaseParallelMergeSort(List<Long> array) {
        this(array, Arrays.asList(new Long[array.size()]));
    }

    private BaseParallelMergeSort(List<Long> array, List<Long> scratch ) {
        this.array = array;
    ...
    protected List<Long> compute() {
        ...
        var leftTask = new BaseParallelMergeSort(leftArray, leftScratch);
        var rightTask = new BaseParallelMergeSort(rightArray, rightScratch);
